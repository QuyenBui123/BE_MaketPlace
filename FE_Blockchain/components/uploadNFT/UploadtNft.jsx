...
const UploadNFT = ({ uploadFileToIPFS, createNFT }) => {
  ...
  const handleCreateLoading = () => {
    ...
    const timeActions = Math.floor(new Date(desiredTimestamp).getTime() / 1000);
    createNFT(name, price, image, description, category, timeActions, router);
    setIsLoading(true);
  };
        ...
        <div className="w-1/2 max-md:w-[100%] grid gap-1">
          ...
          <div className="m-2 flex justify-around">
            <Button
              ...
              isLoading={isLoading}
              startContent={isLoading ? "Loading..." : <MdOutlineCreate />}
              isDisabled={
                !(
                  image &&
                  category &&
